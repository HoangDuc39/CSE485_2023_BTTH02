                ...
                <div class="row mb-5">
                    ...
                    <div class="col-sm-8">
                        <h5 class="card-title mb-2">
                            <a href="" class="text-decoration-none"><?= $article['ten_bhat'] ?></a>
                        </h5>
                        <p class="card-text"><span class=" fw-bold">Bài hát: </span><?= $article['ten_bhat'] ?></p>
                        <p class="card-text"><span class=" fw-bold">Thể loại: </span><?= $article['ten_tloai'] ?></p>
                        ...
                        <p class="card-text"><span class=" fw-bold">Tác giả: </span><?= $article['ten_tgia'] ?></p>
